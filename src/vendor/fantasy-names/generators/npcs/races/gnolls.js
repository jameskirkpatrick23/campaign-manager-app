export default function generator___fantasy___gnolls(type) {
  const nm1 = [
    '',
    '',
    '',
  ...
  let rnd5 = 0;
  let names = 0;
  let rnd12 = Math.floor(Math.random() * nm13.length);
  let rnd22 = Math.floor(Math.random() * nm14.length);
  let nmLast = nm13[rnd12] + nm14[rnd22];
  if (type === 1) {
    ...
    if (i < 5) {
      ...
      names =
        nm5[rnd] + nm6[rnd2] + nm7[rnd5] + nm6[rnd4] + nm8[rnd3] + ' ' + nmLast;
    }
  } else if (type === 2) {
    ...
    if (i < 5) {
      ...
      names =
        nm1[rnd] + nm2[rnd2] + nm4[rnd5] + nm2[rnd4] + nm4[rnd3] + ' ' + nmLast;
    }
  }
  return names;
}

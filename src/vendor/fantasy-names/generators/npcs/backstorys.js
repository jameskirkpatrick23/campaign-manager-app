export default function generator___descriptions___backstorys(gender) {
  ...
  let nm11 = [
    ...
    'became more important to society',
    'got an important job',
    'started to travel a lot',
    'started to travel the world',
    'started to experience the world',
    'started working for the family company',
    'studied a lot',
    'went to college',
    ...
    'did a lot of small jobs',
    'moved to another country',
    'became a travelling adventurer',
    'went on an adventure',
    'improved upon existing powers',
    'got a new pet',
    'got a new companion'
  ];
  let nm12 = [
    ...
    'very successful',
    'growing up fast',
    'meeting a lot of influential people',
    'making many new friends',
    'learning a lot of new skills',
    'gaining a little fame',
    'making some great new friends',
    "about to meet 'Mr(s). Right'",
  ...
  let nm12b = [
    ...
    'is part of an adventure',
    'is trying to reach the top',
    'is unstoppable',
    'is on top of the world',
    'is exploring new areas',
    'is discovering hidden secrets',
    'is discovering hidden treasures',
    'is venturing out',
  ...
  let nm19 = [
    ...
    'still looking for a true calling',
    'still trying to perfect skills',
  ...
  if (gender > 0.5) {
    ...
    if (gender > 0.5) {
      nm11 = [
        ...
        'lost her mother in',
        'lost her father in',
        'lost her parents when they left after',
        'lost her best friend in',
        'lost her home when it was destroyed after',
        'lost her money after',
        'lost her family was they were split up after',
        'lost her brother in',
        'lost her sister in',
        'lost her sisters in',
        'lost her brothers in',
        'lost her siblings in',
        'lost her family in',
        'killed somebody by accident during',
        'killed somebody during',
        'maimed somebody during',
        'accidently maimed somebody during',
      ...
      nm11 = [
        ...
        'lost his mother in',
        'lost his father in',
        'lost his parents when they left after',
        'lost his best friend in',
        'lost his home when it was destroyed after',
        'lost his money after',
        'lost his family was they were split up after',
        'lost his brother in',
        'lost his sister in',
        'lost his sisters in',
        'lost his brothers in',
        'lost his siblings in',
        'lost his family in',
        'killed somebody by accident during',
        'killed somebody during',
        'maimed somebody during',
    ...
    nm12b = [
      ...
      'initiated in a gang',
      'now part of a sinister clan',
      'headed for a life of crime',
      'headed for a life of misery',
    ...
    nm13 = [
      ...
      'While persued by the authority',
      'While persued by a criminal gang',
      'While persued by strangers',
    ...
    nm16 = [
      ...
      'face all obstacles',
      'conquer all fears and doubts',
      "crush all that's in the way",
      "overpower anybody who's a hinderance",
      'keep ahead of the curve',
      'remain out of reach of danger',
      'train to perfection',
      'escape hell',
    ...
    nm19 = [
      'on helping people',
      'as a mercenary for the king',
      'a small job with low pay',
      'on making it in a large tournament',
      'on meeting new, kind people',
      'buying a house',
      'fitting in with society',
      'as a travelling trader',
      'as a travelling gun for hire',
      'as a travelling help for hire',
      'on travelling and surviving of nature',
      'perfecting skills and talents',
      'tracking the people of the past',
      'as help for hire',
      'as a sailor'
    ];
    nm20 = [
      'find some form of redemption',
      'shed the memories of the past',
      'be released of the haunting memories',
      ...
      'find inner peace',
      'find answers to the events of the past',
      'learn more about the past',
      'find vengeance for the actions in the past',
      'forget about the past',
      'start life over on a good note',
      'support a new, honest life'
    ];
    nm21 = [
      'peace of mind',
      'friends',

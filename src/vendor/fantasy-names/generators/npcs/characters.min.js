function generator$descriptions$characters(e) {
  return 1 === e
...
function generator$descriptions$charactersMale() {
  var e = [
    ...
    t = ['blue', 'brown', 'hazel', 'black', 'green', 'amber', 'gray'],
    l = [
      'deep',
      'narrowly',
      'buried',
    ...
    S = parseInt(Math.floor(Math.random() * w.length));
  S > 3 && S < 9
    ? ((e = [
        'Purple',
        'Blue',
  ...
  var A = parseInt(Math.floor(Math.random() * e.length)),
    D = parseInt(Math.floor(Math.random() * r.length)),
    x = parseInt(Math.floor(Math.random() * a.length)),
    F = parseInt(Math.floor(Math.random() * n.length)),
    H = parseInt(Math.floor(Math.random() * i.length)),
    L = parseInt(Math.floor(Math.random() * o.length)),
    W = parseInt(Math.floor(Math.random() * t.length)),
    T = parseInt(Math.floor(Math.random() * l.length)),
    C = parseInt(Math.floor(Math.random() * s.length)),
    E = parseInt(Math.floor(Math.random() * h.length)),
    R = parseInt(Math.floor(Math.random() * g.length)),
    J = parseInt(Math.floor(Math.random() * d.length));
  J > 6 && J < 9
    ? ((m = [
        'resembling a shield',
        'resembling a sword',
  ...
  for (
    var Z = parseInt(Math.floor(Math.random() * m.length)),
      N = parseInt(Math.floor(Math.random() * f.length)),
      P = parseInt(Math.floor(Math.random() * u.length)),
      $ = parseInt(Math.floor(Math.random() * y.length)),
      q = parseInt(Math.floor(Math.random() * c.length)),
      K = parseInt(Math.floor(Math.random() * p.length)),
      Y = parseInt(Math.floor(Math.random() * b.length)),
      V = parseInt(Math.floor(Math.random() * k.length)),
      O = parseInt(Math.floor(Math.random() * v.length)),
      U = parseInt(Math.floor(Math.random() * M.length)),
      X = parseInt(Math.floor(Math.random() * B.length)),
      Q = parseInt(Math.floor(Math.random() * G.length)),
      _ = parseInt(Math.floor(Math.random() * z.length));
    _ == Q;

  )
    _ = parseInt(Math.floor(Math.random() * z.length));
  var ee = parseInt(Math.floor(Math.random() * j.length)),
    re = parseInt(Math.floor(Math.random() * I.length)),
    ae =
      e[A] +
      ', ' +
      r[D] +

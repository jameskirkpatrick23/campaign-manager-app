function generator$descriptions$planets(e) {
  var t = e,
  ...
  var o = 0,
    ...
    n = 0,
    r = 0,
    h = Math.floor(4 * Math.random() + 1);
  1 === h && ((o = 3), (i = 0.2), (r = 3), (n = 0.2)),
    2 === h && ((o = 8), (i = 3), (r = 5), (n = 1)),
    3 === h
      ? ((o = 20), (i = 8), (r = 8), (n = 3))
      : 4 === h && ((o = 40), (i = 20), (r = 15), (n = 5));
  var l = Math.random(),
    d = (Math.random(),
    [
      'Omicron Persei 8',
  ...
  1 === s && m.push.apply(m, u),
    2 === s && m.push.apply(m, p),
    3 === s && m.push.apply(m, y);
  var g = [
    ...
    w = ['five', 'six', 'seven', 'eight', 'nine', 'ten'],
    b = Math.random() * (o - i) + i;
  b = b.toFixed(1);
  var v = Math.random() * (r - n) + n;
  v = v.toFixed(2);
  var k = 40 * Math.random() + 10;
  k = k.toFixed(2);
  var T = Math.floor(400 * Math.random() + 100),
    x = Math.floor(15 * Math.random() + 1),
    M = Math.floor(80 * Math.random() + 10),
    z = Math.floor(5 * Math.random() + 1),
    W = [' red', ' blue', ' white', ' yellow', 'n orange'],
    q = [
      ' circular orbit',
    ...
    E = ['narrow, elliptic orbit'];
  2 === s && q.push.apply(q, E);
  var B = (Math.floor(6e5 * Math.random() + 5e4),
    Math.floor(1e4 * Math.random() + 1e4),
    Math.floor(400 * Math.random() + 50),
  ...
  3 > U && 1 != s && ((x = 0), (M = 0));
  var P = Math.floor(Math.random() * g.length);
  P > 3
    ? (w = [
        'twelve',
        'thirteen',
  ...
  var C = Math.floor(Math.random() * w.length),
    G = Math.floor(Math.random() * W.length),
    ...
    Y = Math.floor(Math.random() * I.length),
    Z = Math.floor(Math.random() * O.length),
    X = Math.floor(Math.random() * j.length),
    _ = Math.floor(Math.random() * F.length),
    ee = Math.floor(Math.random() * N.length),
    te = Math.floor(Math.random() * L.length),
    se =
      'The planet ' +
      d[D] +
      c[R] +
  ...
  return (
    1 === a
      ? (ne = 3 > U ? L[te] : N[ee])
      : 2 === a
        ? ((ne = 'The plant-like organisms on this planet are ' + B[J]),
          (re = S[K]),
          (he = I[Y]),
          (le = O[Z]))
        : 3 === a

function generator$descriptions$towns() {
  ...
  var names9 = [
    ...
    'a comfortable weather system',
    'unique wildlife',
    'spiritual significance',
    'ancestral grounds',
    'ancient, unexplained statues',
  ...
  var names14 = [
    ...
    'rare animal training',
    'advanced armorsmithing',
    'refined baking',
    'elaborate beer brewing techniques',
    'elaborate blacksmithing',
    'refined carpenting',
    ...
    'rare crop farming',
    'ocean fishing',
    'intricate fletching techniques',
    'rare herbalism',
    'sustainable hunting',
    'intricate jewelcrafting',
    'gorgeous leatherworking',
    'advanced medicine',
    'prosperous mining',
    'delicate tailoring',
    'highly skilled thieving',
    'prosperous trade',
    'skilled in the art of war',
    'weaponsmithing',
    'ancient wine brewing techniques',
    'rare wood production',
    'delicate woodcrafting',
    'a strong defence',
    'skilled fighters',
    'strong magicians',
    'deadly archers'
  ...
  if (random17 > 16) {
    ...
    names20 = [
      ...
      'broken roads',
      'overgrown gardens',
      'vines overgrowing everything',
      'unmaintained gardens',
      'foggy surroundings',
      'murky woods',
      'musky swamps',
      'menacing mountain tops',
      'barren grounds',
      'absolute silence',
      'a large graveyard',
      'large cobwebs',
  ...
  var name2 =
    ...
    " wasn't built by a" +
    names3[random3] +
    ' by accident, as it has ' +
    names9[random9] +
    ', which is of great importance to the people of ' +
    names5[random5] +
    ' and its success.';
  ...
  var name5 =
    ...
    ' has a' +
    names10[random10] +
    ' economy, which is mainly supported by ' +
    names11[random11] +
    ', ' +
    names11[random12] +
    ' and ' +
    names11[random13] +
    '. But their biggest strengths are ' +
    names14[random14] +
    ' and ' +
    names14[random15] +
    '.';
  ...
  var name7 =
    ...
    names5[random5] +
    ' is most likely headed towards a ' +
    names41[random41] +

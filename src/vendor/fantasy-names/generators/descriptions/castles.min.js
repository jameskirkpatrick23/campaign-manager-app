function generator$descriptions$castles() {
  var e = [
    ...
    d = ['sizable', 'huge', 'moderate', 'regular', 'great', 'vast'],
    g = [
      'broad',
      'colossal',
      'enormous',
    ...
    u = ['metal', 'wooden'],
    c = [', a draw bridge', ', a regular bridge', ''],
    f = [
      'hot oil pots',
      'archer holes',
      'a moat',
    ...
    H = Math.floor(Math.random() * f.length),
    L = Math.floor(Math.random() * m.length),
    W = Math.floor(Math.random() * y.length),
    $ = Math.floor(Math.random() * w.length),
    D = Math.floor(Math.random() * p.length),
    G =
      e[b] +
      ' ' +
      t[v] +

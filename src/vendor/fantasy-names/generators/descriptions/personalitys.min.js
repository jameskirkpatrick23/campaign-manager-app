function generator$descriptions$personalitys(e) {
  var t = [
  ...
  J > 99 && (L = ["she's", 'her', 'Her', "She's"]);
  var x = Math.floor(Math.random() * H.length);
  if (1 === B)
    var C = Math.floor(Math.random() * u.length),
      E = Math.floor(Math.random() * c.length),
      T = Math.floor(Math.random() * f.length),
      F = Math.floor(Math.random() * m.length),
      D = Math.floor(Math.random() * y.length),
      W = Math.floor(Math.random() * g.length),
      G = Math.floor(Math.random() * p.length),
      K = Math.floor(Math.random() * b.length),
      P = Math.floor(Math.random() * v.length),
      R = Math.floor(Math.random() * w.length),
      I = Math.floor(Math.random() * k.length),
      S = Math.floor(Math.random() * k.length),
      j = Math.floor(Math.random() * k.length),
      z = Math.floor(Math.random() * k.length),
      O = Math.floor(Math.random() * k.length),
      N = Math.floor(Math.random() * M.length),
      q = Math.floor(Math.random() * k.length),
      ...
      V =
        ...
        v[P] +
        '.',
      X = 'Unfortunately ' + L[1] + ' ' + k[S][1] + ' ' + w[R] + '.';
  else
    var C = Math.floor(Math.random() * t.length),
      E = Math.floor(Math.random() * a.length),
      T = Math.floor(Math.random() * n.length),
      F = Math.floor(Math.random() * i.length),
      D = Math.floor(Math.random() * o.length),
      W = Math.floor(Math.random() * s.length),
      G = Math.floor(Math.random() * r.length),
      K = Math.floor(Math.random() * l.length),
      P = Math.floor(Math.random() * h.length),
      R = Math.floor(Math.random() * d.length),
      I = Math.floor(Math.random() * M.length),
      S = Math.floor(Math.random() * M.length),
      j = Math.floor(Math.random() * M.length),
      z = Math.floor(Math.random() * M.length),
      ...
      Y = Math.floor(Math.random() * k.length),
      $ =
        t[C] +
        ' ' +
        A[J] +

function generator$descriptions$personalitys(type) {
  var nm1 = [
    'A lot can be said of',
    ...
    "It's hard to describe a complex person like",
    'Few know the true'
  ];
  var nm2 = [
    'above else know that',
    'if nothing else you should know',
    'at the very least',
  ...
  var nm4 = [
    ...
    'pretty much loved for',
    'often adored for',
    'often admired for',
    'kind of cherished for',
    'most popular for',
    'so well-liked for'
  ];
  var nm5 = [
    ...
    'There are many times when friends',
    'People regularly',
    'Friends frequently',
    'On many occasions people will'
  ];
  var nm6 = [
  ...
  var nm11 = [
    "There's plenty people hate about",
    'A whole lot can be said about',
    "There's plenty to say about",
  ...
  var nm12 = [
    ...
    "There there's the fact",
    'On top of that',
    "That's without even stating"
  ];
  var nm13 = [
    'at least those are kept somewhat in check by habits of being',
  ...
  var nm15 = [
    'Plenty of days have been ruined',
  ...
  var nm17 = [
    'does gave some redeeming qualities',
    'does have some rays of light',
    'does have some lighter sides',
    "isn't completely rotten",
    'has better sides too',
  ...
  var nm18 = [
    ...
    'in good amounts',
    'among true friends',
    'when around good friends',
    'if you look for it',
    'even if in small doses'
  ];
  var nm19 = [
    "it's not like we're dealing with pure evil here",
    "it's not like we've encountered the devil",
    'all considered it could be much worse',
  ...
  var tp = type;
  var rnd13b = Math.floor(Math.random() * nm23.length);
  if (rnd13b > 99) {
    nm25 = ["she's", 'her', 'Her', "She's"];
  }
  var rnd14b = Math.floor(Math.random() * nm24.length);
  if (tp === 1) {
    ...
    var name2 =
      ...
      '.';
    var name3 =
      "Nobody's perfect of course and " +
      nm23[rnd13b] +
      ' has ' +
      nm7[rnd7] +
      ' too. ' +
      ...
      '.';
    var name4 =
      'Fortunately ' + nm25[1] + ' ' + nm21[rnd12][1] + ' ' + nm10[rnd10] + '.';
  }

function generator$descriptions$shotguns() {
  ...
  var nm4 = [
    'a high-power, high-efficiency weapon',
    'a high-power, high-value weapon',
    'a low-cost, high-efficiency weapon',
    'a low-cost, high-power weapon',
    'a low-cost, high-value weapon',
    'a reliable, high-efficiency weapon',
    'a reliable, high-value weapon',
    'a reliable, low-cost weapon',
    'a versatile, high-power weapon',
  ...
  var nm12 = [
    ...
    'a round knob stock',
    'a standard stock',
    'a straight English stock',
    'a trap stock',
    'an extendable stock'
  ];
  var nm13 = [
    'a cheaper type of wood',
    'an expensive wood',
    'exotic wood',
    'metal',
    'plastic',
  ...
  var nm15 = [
    'Japanese man named H. Yoshimitsu',
    'German man named G. Klauss',
    'British man named E. Fawkes',
    'American man named G. Jones',
    'Canadian man names L. Coats',
    'South-African man named A. Botha',
    'Chinese man named B. Chan',
    'Israeli man named D. Mizrahi',
    'Russian man named T. Yakovich',
    'Korean man named Sung S. W',
    'Indian man named C. Mahal',
    'Iranian man named B. Javan',
    'Turkish man named T. Almaz',
    'Italian man named W. Brocato',
    'French man named C. Bouvard',
  ...
  var name2 =
    ...
    ' of the weapon is ' +
    nm6 +
    'mm and has a barrel length of ' +
    nm7 +
    'mm. The weapon weighs ' +
    nm8 +
    'kg.';
  var name3 =
    'The caliber used in this weapon is a ' +
    nm9[rnd9] +
    ' and uses a ' +
    nm10[rnd10] +
    ' firing mechanism. The ammo used most commonly are ' +
    nm11[rnd11a] +
    ', but it also takes ' +
    nm11[rnd11b] +
    ', ' +
  ...
  var name4 =
    ...
    ' are also available.';
  var name5 =
    'The stock is made out of ' +
    nm13[rnd13a] +
    ', but it can also be made out of ' +
    nm13[rnd13b] +
    ' and ' +
    nm13[rnd13c] +
    ' if you so desire.';
  ...
  var name7 =
    'This weapon was designed by a ' +
    nm15[rnd15] +
    ' who initially disgned it for use in ' +
    nm16[rnd16] +
    ", today it's used for " +
    nm16[rnd16a] +
    ', ' +
    ...
    '.';
  var name8 =
    'The name of this weapon is the ' +
    nm17[rnd17a] +
    nm17[rnd17b] +
    '-' +
    nm18[rnd18a] +
    ...
    nm18[rnd18c] +
    nm18[rnd18d] +
    ', but it usually goes by its nickname, ' +
    nm19[rnd19] +
    '.';

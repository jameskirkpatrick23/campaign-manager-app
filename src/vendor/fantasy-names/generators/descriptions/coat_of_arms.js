function generator$descriptions$coat_of_arms() {
  ...
  var nm3 = [
    'double inward curving',
    'double outward curving',
    'downwards curving',
    'heart shaped',
    'long pointed',
    'podium-like',
    ...
    'upwards curving',
    'horn-like cornered',
    'inward curving cornered',
    'inward curving sided',
    'outward curving cornered',
    'outward curving sided',
    'sharp, inwards curving cornered',
    'sharp, inwards pointing cornered',
    'sharp, outwards curving cornered',
    'sharp, outwards pointing cornered',
    'talon-like cornered'
  ];
  var nm4 = [
    'broad curved',
  ...
  var nm7 = [
    ...
    'pedestal',
    'small island surrounded by ocean',
    'snowy landscape',
    'temple top'
  ];
  var nm8 = [
  ...
  var nm9 = [
    ...
    'crosses',
    'fleurs-de-lis',
    'gems raised on stalks',
    'golden arches',
    'heraldic roses',
    'narrow tines',
    'pearls raised on stalks',
    'raised crescents',
    'raised leaves',
    'raised snowflakes',
    'raised stars',
  ...
  var nm11 = [
    'an abundance of different gems',
    'rows of similar gems',
    'two rows of various gems',
    'two rows of similar gems',
    'an abundance of similar gems',
    'rows of various gems',
    'rows of precious gems',
    'two rows of precious gems',
    'an abundance of precious gems',
    'a modest amount of different gems',
    'a modest amount of similar gems',
    'a modest amount of precious gems'
  ];
  var nm12 = [
    'a great',
    'a frog-mouth',
  ...
  var nm14 = [
    ...
    "griffon's head",
    'harp',
    'hawk with closed wings',
    'hawk with spread wings',
    'horse',
    "horse's head",
    'hunting horn',
    'key',
    ...
    "lion's head",
    'mermaid',
    'owl with closed wings',
    'owl with spread wings',
    'pair of antlers',
    'pair of intertwining snakes',
    'pair of large antlers',
    'pair of wings',
    'phoenix with closed wings',
    'phoenix with spread wings',
    'row of feathers',
    'row of leaves',
    'scale',
    'set of arrows',
    'swan with closed wings',
    'swan with spread wings',
    'tiger',
    "tiger's head",
    'tower',
    'tree',
  ...
  var nm18 = [
    ...
    'a dancetty',
    'a diagonal cross',
    'a diagonal, asymmetrically striped',
    'a diagonal, symmetrically striped',
    'a dovetailed',
    'a fret',
    'a gore',
    'a horizontal, asymmetrically striped',
    'a horizontal, symmetrically striped',
    'a nebuly',
    'a nowy',
    'a pall',
    'a potenty',
    ...
    'a saltire',
    'a straight cross',
    'a vertical, assymetrically striped',
    'a vertical, symmetrically striped',
    'a wavy',
    'an angled',
    'an embattled',
    'an embattled grady',
  ...
  var nm24 = [
    'partially wrapped around the supporters',
    ...
    'wrapped around the sides of the shield',
    'hanging above the crest'
  ];
  var nm25 = [
  ...
  var name =
    ...
    rn6 +
    '. All of which rests on a ' +
    nm7[rnd7] +
    '.';
  var name2 =
    'A ' +
    nm8[rnd8] +
    " crown, or coronet, rests atop the shield, it's a crown of " +
    nm9[rnd9] +
    rn10 +
    ' and ' +
    nm11[rnd11] +
    ' decorate the outer sides.';

  var name3 =
    'On top of the coronet sits ' +
    nm12[rnd12] +
    ' helm, which itself supports the crest, in this case ' +
    nm13[rnd13] +
    ' ' +
    nm14[rnd14] +
    '. The coronet and crest are decoratively bound by a roll of fabric, or torse, which carries the main colors used on the shield.';
  var name4 =
    'Lastly, tied to the helmet is ' +
    nm15[rnd15] +
    ' drapery, or mantling, in the shape of ' +
    nm16[rnd16] +
    ' and colored in the main colors, just like the torse.';

  var name5 =
    'The shield itself has ' +
    nm17[rnd17] +
    ' colors which are painted in ' +
    nm18[rnd18] +
    ' pattern. ' +
    rn20 +
    ' as the emblem, or charge, and ' +
    nm23[rnd23] +
    ' ribbon, ' +
    nm24[rnd24] +
    ', carries the motto, which reads: "' +
    nm25[rnd25] +
    '.".';
  var result = '';
  result += name;

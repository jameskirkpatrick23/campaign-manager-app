function generator$descriptions$gems() {
  ...
  var nm8 = [
    'defensive weapon',
    'offensive weapon',
    'defensive spell focus',
    'offensive spell focus',
    'beneficial spell focus',
    'offensive weapon enhancement',
    'defensive weapon enhancement',
    'defensive spell focus enhancement',
    'offensive spell focus enhancement',
    'beneficial spell focus enhancement',
    'defensive artifact',
    'offensive artifact',
    'defensive artifact enhancement',
    'offensive artifact enhancement',
    'defensive jewelry',
    'offensive jewelry',
    'defensive jewelry enhancement',
  ...
  var name =
    ...
    ' with ' +
    nm2[rnd2] +
    ' cut and the size of a ' +
    nm3[rnd3] +
    ' is in ' +
    nm4[rnd4] +
    ' condition. These gems are ' +
    nm5[rnd5] +
    ", but they're " +
    nm6[rnd6] +
    ' gemstone species.';
  var name2 =
    "It's said these gems contain " +
    nm7[rnd7] +
    ' properties which make for a great ' +
    nm8[rnd8] +
    '.';

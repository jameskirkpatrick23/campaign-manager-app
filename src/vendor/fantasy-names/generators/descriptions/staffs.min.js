function generator$descriptions$staffs() {
  for (
    var e = ((60 * Math.random()) | 0) + 160,
      ...
      g = Math.floor(Math.random() * n.length),
      p = Math.floor(Math.random() * i.length),
      f = Math.floor(Math.random() * o.length),
      m = Math.floor(Math.random() * s.length),
      w = Math.floor(Math.random() * r.length),
      u = Math.floor(Math.random() * h.length),
      b = Math.floor(Math.random() * l.length),
      y = Math.floor(Math.random() * d.length),
      v = Math.floor(Math.random() * t.length),
      k = Math.floor(Math.random() * h.length),
      x = Math.floor(Math.random() * l.length);
    x === b;

function generator$descriptions$houses() {
  ...
  var rnd8 = Math.floor(Math.random() * nm8e.length);
  if (rnd7 === 0) {
  ...
  var rnd10 = Math.floor(Math.random() * nm10a.length);
  if (rnd9 === 1) {
  ...
  var rnd25 = Math.floor(Math.random() * nm21.length);

  var name =
    'From the outside this house looks ' +
    nm1[rnd1] +
    ...
    ' windows ' +
    nm5[rnd5] +
    ' and have been added to the house ' +
    nm6[rnd6] +
    '.';

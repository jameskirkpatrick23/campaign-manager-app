function generator$descriptions$constellations() {
  for (
    var e = [
      ...
      m = Math.floor(Math.random() * t.length),
    ...
    y = Math.floor(Math.random() * r.length);
  for (var f = Math.floor(Math.random() * l.length); c === y || c === f; )
    f = Math.floor(Math.random() * l.length);
  for (
    var v = Math.floor(Math.random() * r.length);
    c === y || c === v || f === v;

  )
    v = Math.floor(Math.random() * r.length);
  for (
    var w = Math.floor(Math.random() * r.length);
    c === y || c === w || f === w || v === w;
  ...
  var C =
      ...
      r[c],
    A = '. It can be seen most prominently ' + o[d] + ' ' + t[m] + '.',
    P =

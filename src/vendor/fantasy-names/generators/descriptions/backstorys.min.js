function generator$descriptions$backstorys(e) {
  var t = ['He', 'he', 'his', 'him', 'man'],
    a = [
      'adventurous',
      'affectionate',
      'analytical',
    ...
    l = ['town', 'city', 'village', 'port', 'community', 'capital'],
    h = [
      'without worry',
      'out of trouble',
      'free of worries',
    ...
    d = Math.floor(10 * Math.random()) + 10,
    g = [
      'things changed',
  ...
  for (
    ...
    A = Math.floor(Math.random() * a.length);
  for (var T = Math.floor(Math.random() * a.length); T === A || T === q; )
  ...
  for (
    var z = Math.floor(Math.random() * n.length),
      ...
      D = Math.floor(Math.random() * h.length),
      L = Math.floor(Math.random() * g.length),
      ...
      G = Math.floor(Math.random() * p.length),
    ...
    J = Math.floor(Math.random() * y.length);
  for (
    var K = Math.floor(Math.random() * w.length),
      N = Math.floor(Math.random() * b.length);
    K === N;

  )
    N = Math.floor(Math.random() * b.length);
  var O = Math.floor(Math.random() * v.length),
    Q = Math.floor(Math.random() * M.length),
    U = Math.floor(Math.random() * k.length),
    V = Math.floor(Math.random() * W.length);
  2 === j
    ? ((x[0] =
        t[0] +
        "'s " +

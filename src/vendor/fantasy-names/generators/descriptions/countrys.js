function generator$descriptions$countrys() {
  ...
  var names13 = [
    ...
    'huge waterfalls',
    'small, hidden ponds',
    'pink blossom forests',
    'white blossom forests',
    'red leaved trees',
    'white sandy beaches',
    'dramatic rock formations',
    'neverending fields of green',
    ...
    'white, snowy trees',
    'pristine, snow covered fields',
    'steep, magnificent mountains',
  ...
  var names23 = [
    'successful crops, thanks to',
    'a harmonious way of life, thanks to',
    'a bountiful life, thanks to',
    'a peaceful society, thanks to',
    "the country's natural beauty, thanks to",
    'their freedom, thanks to',
    'their safety, thanks to',
    'plenty of oportunities for stess relief, thanks to',
    'various great entertainment sources, thanks to',
    'the calm nature around them, thanks to',
    'their rich lands, thanks to',
    'great neighborly relations, thanks to',
    'prosperous trade, thanks to',
    'their gentle nature, thanks to',
    'their culture, thanks to',
    'their rich history, thanks to',
    'their healthy lives, thanks to',
    'long lasting peace, thanks to',
    'their bond with nature, thanks to',
    'their skills and powers, thanks to'
  ];
  var names24 = [
    'brilliant leadership',
    'fortunate natural properties',
    'fortunate natural elements',
    'everything they fought for',
    'never giving up',
    'perfecting themselves after years of training',
    'constantly improving themselves',
    'treasures and secrets they found ages ago',
    'advanced techniques learned by passing travellers',
    'amazing teamwork',
    'fertile soils',
    'a fortunate climate',
    'a perfect climate balance',
    'fortunate natural changes',
    'ancient, passed on secrets',
    'inherited lands',
    'fortunate genetics',
    'ancestral spirits',
    'natural spirits',
  ...
  var names25 = [
    ...
    'a cross on a background',
    'a large star',
    'a moon and a star on a background',
    'a moon and two stars on a background',
    'an important spiritual symbol',
    ...
    'one circle',
    "the country's outline on a background",
    'three circles',
    'three connected cirlces',
    'three horizontal stripes and a circle',
    'three horizontal stripes and a triangle',
    'three horizontal stripes',
    'three small crosses',
    'three vertical stripes and a cirlce',
    'three vertical stripes and a triangle',
    'three vertical stripes',
    'two circles',
    'two connected circles',
    'two diagonally divided parts',
    'two horizontal and 1 vertical stripe',
    'two horizontal stripes and a cirlce',
    'two horizontal stripes and a star',
    'two horizontal stripes and a triangle',
    'two horizontal stripes',
    'two jaggedly connected parts',
    'two small crosses',
    'two vertical stripes and a circle',
    'two vertical stripes and a star',
  ...
  var names27 = [
    ...
    'is an arrow',
    'is an eagle',
    'is an important spiritual symbol',
    'are angel wings',
    'are animal teeth',
    'are devil horns',
    'is grain',
  ...
  var names28 = [
    ...
    'on top of a stripe',
    'on top of a wave',
    'on top of three small circles',
    'on top of three stripes',
    'on top of two small circles',
    'on top of two stripes',
    'on top of two waves',
    'surrounded by 3 small stars',
    'surrounded by leaves',
    'surrounded by small stars',
    'surrounded by smaller spiritual symbols',
    'surrounded by stripes',
    'surrounded by sun rays',
    'under a key',
    'with 2 pillars on either side',
    'with two arrows on either side',
    'with two keys on either side',
    'with two shields on either side',
  ...
  if (random17 > 16) {
    names13 = [
      'somber hills',
      'wild rivers',
      'cold, windy mountains',
      'dreary fields',
      'chaotic, overgrown fields',
      'silent mountains',
      'rushing rivers',
      'dried up lakes',
      'gloomy forests',
      'aggressive wildlife',
      'withered flower fields',
      'prickly flowers',
      'ice-cold mountains',
      'forgotten farmlands',
      'dark, gloomy forests',
      ...
      'smelly, overgrown ponds',
      'bleak, bare forests',
      'decaying forests',
      'ominous trees',
      'rocky beaches',
      'fiercy rock formations',
      'desolate grasslands',
      'small, deserted waterfalls',
      'concealed mountain views',
      'somber architecture',
      'icy springs',
      'depressing fields',
      'wild, overgrown forests',
      'black, decaying trees',
      'icy, snow covered fields',
      'steep, sinister mountains',
      'creepy, aquatic wildlife',
      'drying rivers',
      'murky lakes',
    ...
    names15 = [
      'a shunned destination',
      'a skipped destination',
      'an avoided destination',
      'an evaded destination',
      'an infamous destination',
  ...
  if (random23 > 9) {
    ...
    names23 = [
      'failing crops, caused by',
      'recent wars, caused by',
      'impending wars, caused by',
      'ferocious wildlife, caused by',
      'mediocre medicine, caused by',
      'gloomy nature, caused by',
      'questionable safety, caused by',
      'lack of freedom, caused by',
      'lack of food variety, caused by',
      'spreading diseases, caused by',
      'recent destructions, caused by',
      'infertile lands, caused by',
      'a decreasing population, caused by',
      'lack of trade, caused by',
    ...
    names24 = [
      'horrible leadership',
      'unfortunate natural elements',
      'unfortunate natural properties',
      'angered spirits',
      'lackluster and lazy lifestyles',
      'an ancient curse',
      'old superstitions',
      'an unfortunate climate',
      'recent climate changes',
      'lost skills and secrets',
      ...
      'remnants of a dark history',
      'remnants of a civil war',
  ...
  var name3 =
    names1[random1] +
    ' itself is mainly covered in ' +
    names7[random12] +
    ' and has a ' +
    names7b[random3] +
    ' climate, which has lead to a ' +
    names8[random13] +
    ' population, despite the number of people, which means most of them live in ' +
    names10[random15] +
    '.';

  var name4 =
    "The country's landscape is " +
    names12[random17] +
    '; ' +
    names13[random18] +
    ', ' +
    ...
    ' ' +
    names1[random1] +
    ' has to offer, which is why the country is ' +
    names15[random22] +
    ' among foreigners.';
  var name5 =
    'The people of ' +
    ...
    ' are ' +
    names16[random23] +
    ' towards foreigners and tend to welcome them with ' +
    names18[random25] +
    '. They feel foreigners could ' +
    names19[random26] +
  ...
  var name6 =
    ...
    ' has ' +
    names20[random27] +
    ' laws and law enforcement, which is ' +
    names21[random28] +
    '. The people are ' +
    names22[random29] +
    ' due to ' +
    ...
    '.';
  var name7 =
    "This is also reflected in the country's flag, which has " +
    names25[random32] +
    ' in ' +
    names26[random33] +
    names26b[random33b] +

function generator$descriptions$societys() {
  ...
  var names10 = [
    ...
    ', but all this could change in a second.',
  ...
  var names11 = [
    ...
    'a flood',
    'an active volcano',
    'a conflict with a neighboring country',
    'a new disease',
    'pollution of water',
    'air pollution',
    'the rise of gangs',
  ...
  var names12 = [
    ...
    'is implementing a solution',
    'lacks resources',
    'is powerless',
    'is asking other countries to help',
    'is too preoccupied with other issues',
    'is willing to sacrifice a lot',
  ...
  var names18 = [
    'no importance',
    'barely any importance',
    'no real importance',
    'no importance at all',
    'great importance',
    'quite some importance',
    'much importance',
    'a fair deal of importance'
  ];
  var names19 = [
    'adventurous',
    'careful',
  ...
  var names20 = [
    ...
    'are moderately spiritual',
    "aren't very spiritual",
    "aren't spiritual at all",
  ...
  var name =
    ...
    ' is now among the ' +
    names4[random4] +
    ' countries in its corner of the world.';
  var name2 =
    'Their ' +
    names5[random5a] +
    ', ' +
    ...
    ' and ' +
    names5[random5c] +
    ' are among its current greatest strengths. Unfortunately they lack ' +
    names6 +
    names5[random5d] +
    ' and ' +
    names5[random5e] +
  ...
  var name3 =
    ...
    '. There are ' +
    names9[random9] +
    ' opposing groups against the current leadership' +
    names10[random10];
  var name4 =
    'However, the current greatest threat to the nation is ' +
    names11[random11] +
  ...
  var name6 =
    'Religion holds ' +
    names18[random18] +
    ' in their lives and, if anything, has made them more ' +
    names19[random19] +
    '. The people of ' +
    names2[random2] +
    ' ' +

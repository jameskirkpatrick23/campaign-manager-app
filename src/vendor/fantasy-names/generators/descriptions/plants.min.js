function generator$descriptions$plants() {
  var e = [
    ...
    t = ['small', 'large', 'tiny', 'huge', 'thin', 'thick', 'narrow', 'wide'],
    s = [
      'barb shaped',
      'blunt tipped',
      'circular',
    ...
    C = parseInt(Math.floor(Math.random() * a.length)),
    v = parseInt(Math.floor(Math.random() * n.length));
  v > 2 && v < 5
    ? (o = [
  ...
  for (
    var M = parseInt(Math.floor(Math.random() * r.length)),
      D = parseInt(Math.floor(Math.random() * o.length)),
      E = parseInt(Math.floor(Math.random() * i.length)),
      I = parseInt(Math.floor(Math.random() * l.length)),
      F = parseInt(Math.floor(Math.random() * t.length)),
      x = parseInt(Math.floor(Math.random() * s.length)),
      z = parseInt(Math.floor(Math.random() * h.length)),
      A = parseInt(Math.floor(Math.random() * d.length)),
      O = parseInt(Math.floor(Math.random() * u.length));
    O === A;

  )
    random2b = parseInt(Math.floor(Math.random() * u.length));
  for (
    var P = parseInt(Math.floor(Math.random() * c.length));
    P === A || P === O;

  )
    P = parseInt(Math.floor(Math.random() * c.length));
  for (
    var S = parseInt(Math.floor(Math.random() * c.length));
    S === A || S === O || S === P;

  )
    S = parseInt(Math.floor(Math.random() * c.length));
  for (
    var T = parseInt(Math.floor(Math.random() * m.length));
    T === A || T === O || T === P || T === S;

  )
    T = parseInt(Math.floor(Math.random() * m.length));
  var B = parseInt(Math.floor(Math.random() * y.length)),
    G = parseInt(Math.floor(Math.random() * g.length)),
    H = parseInt(Math.floor(Math.random() * p.length)),
    L = parseInt(Math.floor(Math.random() * f.length)),
    j = parseInt(Math.floor(Math.random() * w.length));
  0 === j
    ? (b = [
        'Once pollinated, they grow delicious, small fruits.',
        'Once pollinated, they grow small, inedible fruits.',
    ...
    : 5 === j && (b = ['']);
  var q = parseInt(Math.floor(Math.random() * b.length)),
    V =
      'The ' +
      e[k] +
      ' ' +
    ...
    J = 'They ' + p[H] + '.',
    K = 'As a defense mechanism the ' + e[k] + ' ' + a[C] + ' ' + f[L] + '.',
    $ = 'They rely on ' + w[j] + ' to reproduce. ' + b[q],
    N = '';
  return (
    (N += V),
    (N += '\n'),

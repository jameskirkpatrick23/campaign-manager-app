function generator$descriptions$weapons() {
  var e = [
    ...
    a = ['thick', 'thin', 'wide', 'narrow', 'slim', 'broad'],
    o = [
      'straight',
      'smooth',
      'slightly curved',
    ...
    w = ['marked', 'engraved', 'decorated', 'decorated'],
    b = [
    ...
    W = Math.floor(Math.random() * t.length),
    q = Math.floor(Math.random() * n.length),
    z = Math.floor(Math.random() * r.length),
    N = Math.floor(Math.random() * s.length),
    S = Math.floor(Math.random() * i.length);
  if (A > 4) for (; S < 4; ) S = Math.floor(Math.random() * i.length);
  if (0 === S || 1 === S) var B = Math.floor(3 * Math.random()) + 0;
  else if (S > 1 && S < 5) var B = Math.floor(3 * Math.random()) + 3;
  else if (5 === S || 6 === S) var B = Math.floor(3 * Math.random()) + 6;
  else if (S > 6 && S < 10) var B = Math.floor(3 * Math.random()) + 9;
  else if (10 === S || 11 === S) var B = Math.floor(3 * Math.random()) + 12;
  else var B = Math.floor(3 * Math.random()) + 15;
  var E = Math.floor(Math.random() * l.length);
  if (E < 2) var I = Math.floor(5 * Math.random()) + 0;
  else var I = Math.floor(5 * Math.random()) + 5;
  var Y = Math.floor(Math.random() * d.length),
    $ = Math.floor(Math.random() * m.length);
  if ($ < 3)
    var D = Math.floor(8 * Math.random()) + 0,
      F = Math.floor(6 * Math.random()) + 0;
  else
    var D = Math.floor(Math.random() * f.length),
      F = Math.floor(8 * Math.random()) + 6;
  var O = Math.floor(Math.random() * p.length),
    P = Math.floor(Math.random() * w.length);
  if (P < 2) var R = Math.floor(5 * Math.random()) + 0;
  else if ($ < 3) var R = Math.floor(2 * Math.random()) + 5;
  else var R = Math.floor(3 * Math.random()) + 7;
  if (R < 4)
    if ($ < 3) var C = Math.floor(5 * Math.random()) + 5;
    else var C = Math.floor(5 * Math.random()) + 0;
  else if ($ < 3) var C = Math.floor(5 * Math.random()) + 10;
  else var C = Math.floor(5 * Math.random()) + 15;
  var G = Math.floor(Math.random() * y.length);
  if (G < 4) var H = Math.floor(4 * Math.random()) + 0;
  else var H = Math.floor(10 * Math.random()) + 4;
  if (H < 4)
    if ($ < 3) var J = Math.floor(7 * Math.random()) + 0;
    else var J = Math.floor(4 * Math.random()) + 7;
  else if (H < 12 && H > 3) var J = Math.floor(11 * Math.random()) + 5;
  else if (H > 11) var J = Math.floor(5 * Math.random()) + 22;
  if (J < 6) var K = Math.floor(3 * Math.random()) + 9;
  else if (J < 11 && J > 5) var K = Math.floor(3 * Math.random()) + 12;
  else if (J > 10 && J < 16) var K = Math.floor(4 * Math.random()) + 0;
  else if (J > 15 && J < 22) var K = Math.floor(9 * Math.random()) + 0;
  else var K = Math.floor(5 * Math.random()) + 4;
  if (K < 3) var L = Math.floor(10 * Math.random()) + 15;
  else if (K > 2 && K < 9) var L = Math.floor(5 * Math.random()) + 10;
  else if (K > 8 && K < 12) var L = Math.floor(4 * Math.random()) + 0;
  else var L = Math.floor(6 * Math.random()) + 4;
  var Q =
      'A ' +
      e[T] +
      ', ' +
      ...
      '.',
    U = i[S] + ' ' + h[B],
    V = 'The blade has a ' + l[E] + ', ' + d[Y] + ' cross-guard, ' + c[I] + '.',
    X =
      ' The cross-guard has ' +
      m[$] +
      ' ' +
      ...
      '.',
    Z =
      'A ' + p[O] + ' pommel is  ' + w[P] + ' with ' + b[R] + ', ' + u[C] + '.',
    _ = 'The blade itself is ' + y[G] + '. ' + v[H] + M[J] + '.',
    ee = 'This weapon is used ' + k[K] + '. ' + j[L] + '.',
    ae = '';
  return (
    (ae += Q),
    (ae += '\n'),

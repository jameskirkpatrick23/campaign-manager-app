function generator$descriptions$humanoids(type) {
  ...
  var nm38 = [
    'rows upon rows of small teeth',
    'rows upon rows of teeth',
    'two large fangs',
    'two small fangs',
    'two large canines',
    'two small canines',
    'rows of eerie looking teeth',
    'several rows of sharp teeth',
    'monstrous teeth',
    'curved fangs',
    'rows of crooked teeth',
    'rows of dull teeth',
    'only a few teeth here and there',
    'rows of huge teeth',
    'several huge dull teeth',
    'several huge sharp teeth',
    'several large broken teeth',
  ...
  if (tp === 1) {
    ...
    var name =
      ...
      ' eyes ' +
      nm3[rnd3] +
      ' their surroundings from their ' +
      nm34[rnd34] +
      ' sockets. A ' +
      nm35[rnd35] +
      " nose rests below, but it's the " +
      nm36[rnd36] +
      ' mouth below that takes all the attention. A ' +
      nm37[rnd37] +
      ' smile reveals ' +
      nm38[rnd38] +
      ' and a ' +
    ...
    var name2 =
      ...
      ' ' +
      nm41[rnd41] +
      ' ears sit on each side of its ' +
      nm42[rnd42] +
      ', ' +
      nm43[rnd43] +
      ' head, which itself is covered in ' +
      nm44[rnd44] +
      nm45[rnd45] +
      '.';
    ...
    var name3 =
      ...
      ' ' +
      nm20[rnd20] +
      ' at its sides and end in ' +
      nm51[rnd51] +
      ' hands with ' +
      nm52[rnd52] +
      ' fingers, of which it has ' +
      nm53[rnd53] +
      ' in total.';
    var name4 =
      'Its legs are ' +

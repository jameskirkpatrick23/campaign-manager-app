function generator$descriptions$planets(type) {
  ...
  var intelligent = Math.random();
  var basicLife = Math.random();
  ...
  var names6 = Math.random() * (maxSize - minSize) + minSize; // Size
  names6 = names6.toFixed(1);
  var names7 = Math.random() * (maxGrav - minGrav) + minGrav; // Gravity
  names7 = names7.toFixed(2);

  var names8 = Math.random() * 40 + 10; // Day Length
  names8 = names8.toFixed(2);
  var names9 = Math.floor(Math.random() * 400 + 100); // Year Length

  var names10 = Math.floor(Math.random() * 15 + 1); // Continent Amount
  var names11 = Math.floor(Math.random() * 80 + 10); // Land Mass

  var names12 = Math.floor(Math.random() * 5 + 1); // Moon Amount
  var names13 = [' red', ' blue', ' white', ' yellow', 'n orange'];
  ...
  var names15 = ['harsh', 'cruel', 'dry', 'wet'];

  // Life types, dependant on user choices
  var names16 = Math.floor(Math.random() * 600000 + 50000); // Plant Amount
  var names17 = Math.floor(Math.random() * 10000 + 10000); // Animal Amount
  var names18 = Math.floor(Math.random() * 400 + 50); // Sentient Amount
  var names19 = Math.floor(Math.random() * 3 + 1); // Super Sentient or Not
  ...
  var random22a = Math.floor(Math.random() * names22a.length);
  var random22b = Math.floor(Math.random() * names22b.length);
  var random22c = Math.floor(Math.random() * names22c.length);
  var random22d = Math.floor(Math.random() * names22d.length);
  var random23a = Math.floor(Math.random() * names23a.length);
  var random23b = Math.floor(Math.random() * names23b.length);
  var random23c = Math.floor(Math.random() * names23c.length);
  var random23d = Math.floor(Math.random() * names23d.length);
  var random23e = Math.floor(Math.random() * names23e.length);
  ...
  var name2 =
    ...
    ' is about ' +
    names6 +
    ' times bigger than Earth and its gravity is about ' +
    names7 +
    ' times that of Earth.';
  ...
  var name3 =
    'A single day lasts ' +
    names8 +
    ' hours and a year lasts ' +
    names9 +
    ' days. The planet is made up of ' +
    names10 +
    ' continents, which make up ' +
    names11 +
    "% of the planet's landmass.";
  var name4 =
    names12 +
    ' moon(s) orbit the planet and ' +
    names1[random1] +
    ' itself orbits a' +
    names13[random13] +
    ' sun in a' +

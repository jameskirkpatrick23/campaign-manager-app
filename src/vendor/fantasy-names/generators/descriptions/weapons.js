function generator$descriptions$weapons() {
  ...
  var nm8 = [
    'One sharp edge',
    'A single, sharp edge',
    'With just one razor-sharp edge',
    'Because its sharp on just one edge',
    'With a single, sharp edge',
    'A sharp, dual-edged blade',
    'The sharp, dual-edged blade',
    'Dual-edged and razor-sharp',
    'With its sharp, dual-edged blade',
    'Because its sharp on both its edges',
    'A fine, sharp point',
    'The razor-sharp point',
    'With a point as sharp as a razor',
    'With just a razor-sharp point',
  ...
  var nm12 = [
    "just large enough to protect the owner's fingers",
  ...
  var nm15 = [
    ...
    'which shows how ordinary this weapon is',
    'a sign of mass production',
  ...
  var nm18 = [
    "the sword maker's symbol",
    "the sword maker's signature",
    'a quality symbol',
    'the symbol of the house this sword belongs to',
    'the symbol of its owner',
    'a fairly common gem',
    'common gems',
    'precious gems',
    'gilded linings',
  ...
  var nm19 = [
    'a symbol one can be proud of',
    'a symbol of true greatness',
    'a symbol many are jealous of',
    'a famous symbol and rightfully so',
  ...
  var nm23 = [
    ...
    'only during special occassions',
    'only on rare occassions',
    'only for ceremonial purposes',
    'only as a bragging object',
    'only as a decorational piece',
    'only as a display of wealth',
    'by royalty and the noble',
    'only by those with vast amounts of wealth',
    'by just about anybody',
    'by anybody with a decent amount of money',
    'the lower ranked guards',
    'by the royal guard',
    'by higher ranked guards',
    'by champions and proven fighters'
  ];
  var nm24 = [
    'A decent weapon which serves its purpose',

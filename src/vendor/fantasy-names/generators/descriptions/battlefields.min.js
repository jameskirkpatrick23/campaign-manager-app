function generator$descriptions$battlefields() {
  var e = ['field', 'forest', 'farm field', 'beach', 'village', 'town', 'city'],
    t = [
      'bodies',
      'blood',
      'gore',
    ...
    o = ['pink', 'silver', 'brown', 'blue', 'black', 'gray', 'khaki'],
    a = [
      'peaceful, ',
      'quiet, ',
      'tranquil, ',
    ...
    n = ['green', 'lush', 'snowy', 'tender', 'luscious', 'rich'],
    r = [
      'ruthless battle',
      'disastrous fight',
    ...
    g = ['dead', 'dead and wounded', 'wounded'],
    u = ' the losing side ',
    c = [
      'lay in heaps across',
    ...
    x = ['years', 'decades', 'ages', 'generations', 'a lifetime'],
    z = [
      'explosion holes',
    ...
    A = ['trees', 'flowers', 'grass', 'bushes', 'shrubs', 'plants'],
  ...
  for (
    ...
    j = Math.floor(Math.random() * t.length);
  for (var R = Math.floor(Math.random() * t.length); R === $ || R === j; )
    R = Math.floor(Math.random() * t.length);
  for (
    var S = Math.floor(Math.random() * o.length),
      W = Math.floor(Math.random() * o.length);
    W === S;
  ...
  var B = Math.floor(Math.random() * a.length),
    ...
    F = Math.floor(Math.random() * h.length),
    G = Math.floor(Math.random() * s.length),
  ...
  for (
    var N = Math.floor(Math.random() * c.length),
      ...
      P = Math.floor(Math.random() * b.length);
    P === O;

  )
    P = Math.floor(Math.random() * b.length);
  var Q = Math.floor(Math.random() * w.length),
    U = Math.floor(Math.random() * y.length),
  ...
  for (
    var Y = Math.floor(Math.random() * k.length),
      Z = Math.floor(Math.random() * q.length),
      _ = Math.floor(Math.random() * T.length),
      ee = Math.floor(Math.random() * x.length),
      te = Math.floor(Math.random() * z.length),
      oe = Math.floor(Math.random() * z.length);
    oe === te;

  )
    oe = Math.floor(Math.random() * z.length);
  for (var ae = Math.floor(Math.random() * z.length); ae === te || ae === oe; )
    ae = Math.floor(Math.random() * z.length);
  for (
    var ne = Math.floor(Math.random() * A.length),
      re = Math.floor(Math.random() * A.length);
    W === S;

  )
    re = Math.floor(Math.random() * A.length);
  for (var ie = Math.floor(Math.random() * A.length); ie === ne || ie === re; )

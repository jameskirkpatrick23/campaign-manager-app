function generator$descriptions$houses() {
  var e = [
    ...
    S = ['two bedrooms', 'three bedrooms', 'four bedrooms', 'five bedrooms'],
    q = [
      'a small',
      'a large',
      'a cozy',
    ...
    O = ['storage room', 'garage', 'basement'],
    j = '',
    A = '',
    ...
    D = Math.floor(Math.random() * u.length);
  0 === C
    ? ((D = Math.floor(Math.random() * r.length)), (j = r[D]))
    : 1 === C
      ? ((D = Math.floor(Math.random() * i.length)), (j = i[D]))
      : 2 === C
        ? ((D = Math.floor(Math.random() * l.length)), (j = l[D]))
        : 3 === C
          ? ((D = Math.floor(Math.random() * d.length)), (j = d[D]))
          : (j = u[D]);
  var E = Math.floor(Math.random() * g.length),
    H = Math.floor(Math.random() * c.length);
  1 === E
    ? ((H = Math.floor(Math.random() * w.length)), (A = w[H]))
    : 2 === E
      ? ((H = Math.floor(Math.random() * f.length)), (A = f[H]))
      : (A = c[H]);
  var I = Math.floor(Math.random() * y.length),
    J = Math.floor(Math.random() * p.length),
    K = Math.floor(Math.random() * m.length),
    N = Math.floor(Math.random() * x.length),
    P = Math.floor(Math.random() * b.length),
    Q = Math.floor(Math.random() * T.length),
    V = Math.floor(Math.random() * v.length),
    W = Math.floor(Math.random() * M.length),
    X = Math.floor(Math.random() * k.length),
    Y = Math.floor(Math.random() * S.length),
    Z = Math.floor(Math.random() * q.length),
    _ = Math.floor(Math.random() * z.length),
    ee = Math.floor(Math.random() * L.length),
    oe = Math.floor(Math.random() * O.length),
    ne = Math.floor(Math.random() * q.length),
    te =
    ...
    re =
      ...
      b[P] +
      '.',
    ie = 'The house itself is surrounded by ' + T[Q] + '.',
    le = '';
  return (
    (le += te),
    (le += '\n'),

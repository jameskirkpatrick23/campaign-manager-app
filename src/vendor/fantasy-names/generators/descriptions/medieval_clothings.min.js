function generator$descriptions$medieval_clothings(e) {
  var t = [
      'delicate',
      'elegant',
      'fancy',
    ...
    h = ['leather belt', 'ribbon', 'cloth belt', 'rope belt', 'cloth band'],
    i = ['fairly high', 'quite high', 'low', 'high', 'fairly low', 'quite low'],
    s = [
    ...
    c = ['fair', 'large', 'good', 'short', 'decent', 'long', 'small'],
    g = [
      'broad curve',
      'narrow curve',
      'narrow tip',
    ...
    Q = ['leather belt', 'cloth belt', 'rope belt', 'cloth band'],
    _ = [
      'a big belt buckle',
      'a simple knot',
      'a small belt buckle',
    ...
    F = ['boots', 'shoes'],
    G = ['leather', 'hide', 'fur', 'leather', 'leather', 'cloth'],
    I = e;
  if (1 === I) {
    for (
    ...
    var O = Math.floor(Math.random() * l.length),
      ...
      S = Math.floor(Math.random() * h.length),
      U = Math.floor(Math.random() * i.length),
      V = Math.floor(Math.random() * s.length),
      W = Math.floor(Math.random() * d.length),
      X = Math.floor(Math.random() * c.length),
      Y = Math.floor(Math.random() * g.length),
      Z = Math.floor(Math.random() * u.length),
      ee = Math.floor(Math.random() * f.length),
      te = Math.floor(Math.random() * w.length),
      oe = Math.floor(Math.random() * m.length),
      ae = Math.floor(Math.random() * n.length),
      le = Math.floor(Math.random() * b.length),
      re = Math.floor(Math.random() * y.length),
      ne =
        'Her ' +
        t[J] +
    ...
    var se = Math.floor(Math.random() * v.length),
      de = Math.floor(Math.random() * M.length),
      ce = Math.floor(Math.random() * p.length),
      ge = Math.floor(Math.random() * k.length),
      ue = Math.floor(Math.random() * j.length);
    se > 2 && (rnd24 = ' shirt ');
    var fe = Math.floor(Math.random() * T.length),
      we = Math.floor(Math.random() * x.length),
      me = Math.floor(Math.random() * H.length),
      be = Math.floor(Math.random() * $.length),
      ye = Math.floor(Math.random() * A.length),
      ve = Math.floor(Math.random() * B.length),
      Me = Math.floor(Math.random() * Q.length),
      pe = Math.floor(Math.random() * _.length),
      ke = Math.floor(Math.random() * z.length),
      je = Math.floor(Math.random() * T.length),
      qe = Math.floor(Math.random() * C.length),
      Te = Math.floor(Math.random() * D.length),
      xe = Math.floor(Math.random() * E.length),
      He = Math.floor(Math.random() * F.length),
      ne =
        'His ' +
        v[se] +
        ' sleeved, ' +

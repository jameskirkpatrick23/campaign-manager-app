function generator$descriptions$battlefields() {
  ...
  var nm7 = [
    'be filled with the scent of food from a nearby town',
  ...
  var nm8 = [
    'thick with the scent of death and decay',
  ...
  var nm9 = [
    'enough to make even the bravest tremble in fear',
    'something no survivor will ever forget',
    'hell has descended upon this area',
  ...
  var nm10 = [
    ...
    'Two parties',
    'Two trained armies',
    'Two barely trained groups',
    'An army and a rebellion',
    'An army of rebels and an army of warriors'
  ];
  var nm11 = [
    'for supremacy',
    'for resources',
    'over a mere difference in lifestyle and belief',
    'for independance',
    'because of a betrayal',
    'because of the lies of their leaders',
    'without knowing the true reason',
    'for control of the area',
    'due to a difference in beliefs'
  ];
  var nm12 = [
    "it's clear who will win",
  ...
  var nm15 = [
    ...
    'are abundant and lay in heaps around',
    'are spread around',
  ...
  var nm19 = [
    'the rush of victory coursing through their bodies',
    'victory ready for the taking',
    'victory becoming more and more likely',
    'a certainty of victory',
    'the thought of victory in their minds'
  ];
  var nm20 = ' the winning side ';
  var nm21 = [
    'pushes harder and harder on their enemies',
    'pushes on and on',
    ...
    "fights as if they're invinsible",
    'fights with new found strength'
  ];
  var nm22 = [
    'bloodlust',
    'a frenzy',
  ...
  var nm23 = [
    'frantically killing any enemy in sight',
  ...
  if (rnd1 > 1 && rnd1 < 4) {
    ...
    nm7 = [
      'be rich in scents of food, fresh fish and new brews',
  ...
  if (rnd12 > 4) {
    ...
    nm17 = [
      ...
      'weapons clenched in their hands',
      'gritting teeth',
      'their muscles tense and anxious',
      'boots stepping firmly',
      'eyes searching their surroundings',
      'nervous, yet steady breathing'
    ];
    nm18 = [
      'they courageously fight on',
    ...
    nm19 = [
      'the uncertainty of battle coursing through their minds',
      ...
      'both confidence and panic',
      'a strong possibility of pain or death',
      'the possibility of death shaking their knees',
      "no way to know if they'll live or die"
    ];
    nm20 = ' the other side ';
    nm21 = [
      'fights like their lives depend on it, which they do',
  ...
  if (rnd22 > 2 && rnd22 < 6) {
    nm23 = [
      'barely able to force their bodies in motion',
  ...
  var name =
    ...
    ' and ' +
    nm3[rnd3b] +
    ' are the new colors of what was once a ' +
    nm4[rnd4] +
    nm5[rnd5] +
    ' ' +
    nm1[rnd1] +
    ', which has now become the stage of a ' +
    nm6[rnd6] +
    '.';
  var name2 =
    'The air which would normally ' +
    nm7[rnd7] +
    ' is now ' +
    nm8[rnd8] +
    ', ' +
  ...
  var name3 =
    ...
    ' the ' +
    nm1[rnd1] +
    ' and the faces of the fighters are' +
    nm16 +
    'with ' +
    nm17[rnd17a] +
    ' and ' +
  ...
  var name5 =
    'The toll on both nature and humanity is ' +
    nm25[rnd25] +
    ". It'll likely take " +
    nm26[rnd26] +
    ' before this ' +
    nm1[rnd1] +
    " will have recovered. It's clear " +
    nm27[rnd27a] +
    ', ' +
    nm27[rnd27b] +
    ' and ' +

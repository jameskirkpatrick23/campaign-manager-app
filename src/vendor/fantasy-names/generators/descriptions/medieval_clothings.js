function generator$descriptions$medieval_clothings(type) {
  ...
  var nm13 = [
    ...
    'slightly shorter than her arms',
    'almost the length of her arms',
    'fairly short',
    'a little short'
  ];
  var nm14 = [
  ...
  if (tp === 1) {
    ...
    var name =
      'Her ' +
      nm1[rnd] +
      ' dress flows from top to bottom and has a ' +
      nm2[rnd2] +
      ', which ' +
      nm3[rnd3] +
      ' reveals the ' +
      nm1[rnd1] +
      ' dress worn below it. The ' +
      nm4[rnd4] +
      ', ' +
      nm5[rnd5] +
    ...
    var name2 =
      ...
      ' the dress ' +
      nm9[rnd9] +
      ' the dress below. The front of the top dress ' +
      nm10[rnd10] +
      ', the back continues to flow a ' +
      nm11[rnd11] +
      ' length behind her and ends in a ' +
      nm12[rnd12] +
      '.';
    var name3 =
      'Her sleeves are ' +
      ...
      ', ' +
      nm17[rnd17] +
      ' bands, these are the same fabric and color used to outline the ' +
      nm18[rnd18] +
      ' of the dress.';
  } else {
    ...
    var name2 =
      'The jacket has a ' +
      nm28[rnd28] +
      ' which reveals part of the ' +
      nm29[rnd29] +
      ' shirt worn below it and is worn with a ' +
      nm30[rnd30] +
      ' ' +
      nm31[rnd31] +
      ...
      '.';
    var name3 =
      'His pants are simple and ' +
      nm25[rnd34] +
      ' and reach down to his ' +
      nm35[rnd35] +
      ' ' +
      nm38[rnd38] +
      '. The ' +

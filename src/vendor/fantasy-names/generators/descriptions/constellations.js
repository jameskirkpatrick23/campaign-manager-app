function generator$descriptions$constellations() {
  var names1 = [
    'four',
    'five',
    'six',
  ...
  var names4 = [
    ...
    'just above the Northeastern horizon',
  ...
  var names5 = [
    ...
    'just before the autumn equinox',
  ...
  var names8 = [
    'be a little mischievious',
    'be adventurous',
    'be caring',
    'be charismatic',
    'be dignified',
    'be forgiving',
    'be friends of animals',
    'be generous',
    'be great friends',
    'be great parents',
    'be humble',
    ...
    'become hard workers',
    'become ocean explorers',
    'become outstanding role models',
    'become rich',
    'become strong soldiers ',
    'become succesful in life',
    'become talented artists',
    'become travelers',
    'find happiness',
    'have a great sense of humor',
    'have great intuitions',
    'posses hidden talents',
  ...
  var random13 = Math.floor(Math.random() * names9.length);
  while (
    random3 === random9 ||
    random3 === random13 ||
    random10 === random13 ||
  ...
  var random14 = Math.floor(Math.random() * names3.length);
  while (
    random3 === random9 ||
    random3 === random14 ||
    random10 === random14 ||
  ...
  var name =
    'Made up of ' +
    names1[random1] +
    ' stars, the constellation called ' +
    names2[random2] +
    ' roughly resembles the shape of a ' +
    names3[random3];
  var name2 =
    '. It can be seen most prominently ' +
    names4[random4] +
    ' ' +
    names5[random5] +
    '.';
  ...
  var name3 =
    'In an ancient society, this constellation was seen as the representation of the god of ' +
    names6[random6] +
    ', which is how it received the name still used today.';

  var name4 =
    'In astrology, this constellation bears the sign of ' +
    names7[random7] +
    ', those born under it are believed to ' +
    names8[random8] +
    '.';
  var name5 =
    "They're suposed to be a good match with those born under the constellations resembling a " +
    names3[random9] +
    names9[random10] +
    ' and ' +
    names3[random11] +
    '. ';
  var name6 =
    "But they don't match well with those born under the " +
    names3[random12] +
    names9[random13] +
    ' and ' +
    names3[random14] +
